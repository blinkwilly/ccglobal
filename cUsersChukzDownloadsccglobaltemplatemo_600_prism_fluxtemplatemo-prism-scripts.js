...
const portfolioData = [
    {
        ...
        description: 'School of Light begins at 8am to 9am, then Service start by 9am to 11am',
...
const skillsData = [
    ...
    // { name: 'Node.js', icon: 'Ìø¢', level: 90, category: 'backend' },
    // { name: 'TypeScript', icon: 'Ì≥ò', level: 88, category: 'frontend' },
    // { name: 'AWS', icon: '‚òÅÔ∏è', level: 92, category: 'cloud' },
    // { name: 'Docker', icon: 'Ì∞≥', level: 85, category: 'cloud' },
    // { name: 'Python', icon: 'Ì∞ç', level: 93, category: 'backend' },
    // { name: 'Kubernetes', icon: '‚ò∏Ô∏è', level: 82, category: 'cloud' },
    // { name: 'GraphQL', icon: '‚óà', level: 87, category: 'backend' },
    // { name: 'TensorFlow', icon: 'Ì¥ñ', level: 78, category: 'emerging' },
    // { name: 'Blockchain', icon: 'Ì¥ó', level: 75, category: 'emerging' },
    // { name: 'Vue.js', icon: 'Ì≤ö', level: 85, category: 'frontend' },
    // { name: 'MongoDB', icon: 'ÌΩÉ', level: 90, category: 'backend' }
];
